...
class AccountPaymentGroupInherit(models.Model):
    ...
    def compute_withholdings(self):
        ...
        for rec in self:
            ...
            if rec.partner_id.alicuota_ret_misiones > 0 or rec.partner_id.alicuota_ret_misiones_3 or rec.partner_id.alicuota_ret_misiones_1:
                retencion = rec.partner_id.get_amount_alicuot_misiones('ret',rec.payment_date)
                ...
                _imp_ret = self.env['account.tax'].search([
                    ...
                    ('tax_sircar_misiones_ret','=',True)], limit=1)
                ...
                if retencion > 0:
                    rec.payment_ids = [(0,0, {
                        ...
                        'tax_withholding_id': _imp_ret.id,
                        'payment_method_description': 'Retencion IIBB SIRCAR Misiones',
